...
-- description: Detected SQL objects called by process steps.
BEGIN TRY
    ...
    BEGIN TRY
        ...
        BEGIN
            BEGIN TRY
                ...
                INSERT INTO #process_steps (process_name, step_id, step_name, database_name, subsystem, command)
                SELECT @job_name, step_id, step_name, database_name, subsystem, command
                FROM #step_raw;
            END TRY
            BEGIN CATCH
