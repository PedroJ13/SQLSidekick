...
-- description: Full lineage from SQL Agent jobs to called SQL objects and referenced catalog objects.
BEGIN TRY
    ...
    SELECT
        ...
        sed.referenced_id AS referenced_object_id,
    ...
    ORDER BY process_name, step_id, referenced_schema, referenced_object;
END TRY
BEGIN CATCH
    SELECT
        ...
        CAST(NULL AS int) AS referenced_object_id,
